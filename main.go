...
import (
	...
	"github.com/mamalovesyou/protoc-gen-openapi/generator"
...
func main() {
	conf := generator.Configuration{
		...
		SkipEmpty:       flags.Bool("skip_empty", false, `If true, skips generation if no messages are found in the input files.`),
	}
